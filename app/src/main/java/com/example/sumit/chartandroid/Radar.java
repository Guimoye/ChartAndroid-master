...
public class Radar extends AppCompatActivity {
    ...
    public void cargarDatos() {
                ...
                entries.add(new Entry(Float.valueOf("3.1"), 0));
                entries.add(new Entry(Float.valueOf("30.1"), 1));
                entries.add(new Entry(Float.valueOf("20.1"), 2));
                entries.add(new Entry(Float.valueOf("10.1"), 3));
                entries.add(new Entry(Float.valueOf("8.1"), 4));
